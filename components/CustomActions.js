...
export default class CustomActions extends React.Component {
    ...
    //User to take a photo from camera
    takePhoto = async () => {
        //pallow access to camera and media library
    ...
    //users to get their location by using GPS
    getLocation = async () => {
        ...
        try {
            if (status === "granted") {
                ...
                // locate the position on the map by latitude and longitude
                if (result) {
                    this.props.onSend({
                        location: {
